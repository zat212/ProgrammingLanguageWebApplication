...
export default function PythonBeginner() {
  ...
  if (loading || statusLoading) return <p className="text-center mt-10">Loading Python lessons and user status...</p>;
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Python Beginner Lessons</h1>
